...
export const metadata: Metadata = {
  title: "AI CMMS",
  description:
    "AI-powered Computerized Maintenance Management System by Blue Oracle Consulting. Track assets, manage work orders, and get predictive maintenance insights.",
};
...
export default function AICMMSPage() {
  return (
    <>
      {/* Hero */}
      ...
      <CTASection
        title="Ready to see AI CMMS in action?"
        description="Request a personalized demo or inquire about purchasing AI CMMS for your organization."
